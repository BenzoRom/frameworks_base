...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private static final int MSG_CLEAR_PROXIMITY = 27;
    ...
    private void toggleTorchProximityCheck() {
    ...
    public void init(Context context, WindowManagerFuncs windowManagerFuncs) {
        ...
        mProximityTimeOut = mContext.getResources().getInteger(
                com.android.internal.R.integer.config_torchProximityTimeout);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mHideGlobalActionsOnSecure = Settings.Secure.getIntForUser(resolver,
                    Settings.Secure.POWER_MENU_HIDE_ON_SECURE, 0,
                            UserHandle.USER_CURRENT) != 0;
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        final int keyCode = event.getKeyCode();
        final boolean down = event.getAction() == KeyEvent.ACTION_DOWN;
        final boolean isVolumeRockerWake = !isScreenOn() && mVolumeRockerWake
