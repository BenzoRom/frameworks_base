...
import static android.provider.Settings.System.STATUS_BAR_BATTERY_SHOW_PERCENT;
...
public class BatteryMeterView extends LinearLayout implements
    ...
    private static final String STATUS_BAR_BATTERY_STYLE =
            "benzosystem:" + Settings.System.STATUS_BAR_BATTERY_STYLE;
        ...
        mUserTracker = new CurrentUserTracker(broadcastDispatcher) {
            ...
            public void onUserSwitched(int newUserId) {
                ...
                getContext().getContentResolver().registerContentObserver(
                        Settings.System.getUriFor(STATUS_BAR_BATTERY_SHOW_PERCENT),
    ...
    private void updateShowPercent() {
        ...
        final int showBatteryPercent = Settings.System.getIntForUser(
                getContext().getContentResolver(), STATUS_BAR_BATTERY_SHOW_PERCENT, 0, mUser);
