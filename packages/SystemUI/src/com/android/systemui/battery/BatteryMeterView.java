...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    void updateShowPercent() {
        ...
        final int showBatteryPercent = Settings.System.getIntForUser(
                getContext().getContentResolver(), STATUS_BAR_BATTERY_SHOW_PERCENT, 0,
    ...
    void scaleBatteryMeterViews() {
        ...
        boolean isCircleStyle = getBatteryStyle() == BATTERY_STYLE_CIRCLE
        ...
        float mainBatteryWidth = (isCircleStyle ?
