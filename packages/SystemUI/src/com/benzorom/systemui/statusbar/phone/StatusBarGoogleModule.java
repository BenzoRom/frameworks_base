...
/**
 * Dagger Module providing StatusBarGoogle.
 */
@Module(includes = {
        StatusBarPhoneDependenciesModule.class,
        StatusBarDependenciesModule.class,
        NotificationsModule.class,
        NotificationRowModule.class})
public abstract class StatusBarGoogleModule {
    /**
     * Provides optional ReverseChargingViewController for StatusBarGoogle.
     */
    @Provides
    @SysUISingleton
    static Optional<ReverseChargingViewController> provideReverseChargingViewControllerOptional(
            BatteryController batteryController,
            Lazy<ReverseChargingViewController> reverseChargingViewControllerLazy) {
        if (batteryController.isReverseSupported()) {
            return Optional.of(reverseChargingViewControllerLazy.get());
        }
